package ck.top.client;

import ck.top.rpc.RpcClient;
import ck.top.rpc.Request;
import ck.top.rpc.RpcServer;
import ck.top.skipList.SkipListLevel;
        ...
        while (sc.hasNextLine()) {
            ...
            if (Objects.equals(command, "display")) {
                ...
                if (result instanceof List) {
                    displayLevels((List<SkipListLevel<String, String>>) result);
                } else {
